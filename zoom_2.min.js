...
(e=c.b=!1,c.g()):(e=setTimeout(function(){e=!1},300),c.b=!0))});a.parentNode.addEventListener("touchmove",function(b){var a=b.touches;if(!a||1==a.length&&!c.h.pan||!c.b)return!1;b.preventDefault();b=c.i;var a=1<a.length?l(a):d(a),f=n(b[1],b[0]),e=n(a[1],a[0]),g;if(c.h.rotate){var y=p(f,f);g=p(f,e)/y;f=(f[0]*e[1]-f[1]*e[0])/y;g=[[g,f],[-f,g]]}else g=Math.sqrt(p(e,e))/Math.sqrt(p(f,f)),g=[[g,0],[-0,g]];c.f=new r(js,n(a[0],q(g,b[0])));c.c.style.transform=t(u(c.f,c.a))});a.parentNode.addEventListener("touchend",
function(){c.b&&(c.a=u(c.f,c.a),c.b=!1)})}z.prototype.g=function(){if(window.requestAnimationFrame){var a=this.a,b=null,d=this,l=function(c){b||(b=c);c=(c-b)/100;if(1<c)d.a=v,d.b=!1,d.c.style.transform=t(d.a);else{var e=a.a,x=v.a;d.c.style.transform=t(new r([m(h(1-c,e[0]),h(c,x[0])),m(h(1-c,e[1]),h(c,x[1]))],m(h(1-c,a.b),h(c,v.b))));window.requestAnimationFrame(l)}};window.requestAnimationFrame(l)}else this.a=v,this.b=!1,this.c.style.transform=t(this.a)};z.prototype.reset=z.prototype.g;
window.Zoom=z;
